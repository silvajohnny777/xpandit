...
const Modal:React.FC = () => {
    ...
    return (
        ...
        <div className="h-full w-full bg-[#cccccc] fixed top-0 bg-opacity-70 flex justify-center items-center">
            ...
            <div className="lg:w-[748px] w-full h-[682px] bg-[white] absolute opacity-100 px-[58px] py-[30px] overflow-auto">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="cursor-pointer flex flex-col items-center" onClick={() => dispatch(addMovieDetail(null))}>
                            ...
                            <div className="text-[#718FA2] text-[8px]">close</div>
                        </div>
                    </div>                

                    <div className="text-[#78849EB9] text-[14px] py-[16px]">
                        <h3>Year</h3>
                    ...
                    <div className="text-[#78849EB9] text-[14px] py-[16px]">
                        <h3>Director</h3>
                        <p className="text-[#78849E] text-[16px] mt-[4px]">John Doe</p>
                    </div>
                    ...
                    <div className="text-[#78849EB9] text-[14px] py-[16px]">
                        <h3>Revenue</h3>
                        <p className="text-[#78849E] text-[16px] mt-[4px]">{movieDetails?.revenue.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</p>
                    </div>
